...
function configureLocale(config) {
    return __awaiter(this, void 0, void 0, function () {
        var matchResult, language, territory, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, trySetLanguageAndTerritory(config, 'en', undefined)];
                case 4:
                    // Fallback to en
                    result = _a.sent();
                    _a.label = 5;
...
function trySetLanguageAndTerritory(config, language, territory) {
    var filePath = path.join(config.directory, language);
    if (territory) {
            ...
            request_1.onreadystatechange = function () {
                if (request_1.readyState === XMLHttpRequest.DONE) {
                    if (request_1.status === 200) {
                        diagnosticMessages = JSON.parse(request_1.responseText);
                        return resolve(true);
                    }
                    else {
