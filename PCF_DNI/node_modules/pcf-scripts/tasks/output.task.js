...
class CreateOutputTask {
    ...
    copyResourcesToOutdir(context, outDir, diag) {
        ...
        const processor = new manifestprocessor_1.ManifestProcessor(context.getControlManifest().getManifestData());
        ...
        const relativePaths = context.getControlManifest().getResources(false);
