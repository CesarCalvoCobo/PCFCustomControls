...
class ManifestTypesGenerator {
    constructor() {
        ...
        this.typeGroups = {};
        // keep track of non-required properties
        this.optional = {};
        this.outputs = {};
    ...
    createInputProperties() {
        const inputProperties = Object.keys(this.parameters).map(propName => {
            ...
            /*modifiers*/ undefined, 
            /*name*/ propName, 
            /*questionToken*/ propName in this.optional ? ts.createToken(ts.SyntaxKind.QuestionToken) : undefined, 
            /*type*/ typeRef, 
